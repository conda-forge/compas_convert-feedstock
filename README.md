...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/compas_convert-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13703&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/compas_convert-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `compas_convert` can be installed with:

```
conda install compas_convert
```

It is possible to list all of the versions of `compas_convert` available on your platform with:
